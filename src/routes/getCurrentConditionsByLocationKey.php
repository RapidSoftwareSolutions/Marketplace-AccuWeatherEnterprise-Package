...
$app->post('/api/AccuWeatherEnterprise/getCurrentConditionsByLocationKey', function ($request, $response) {
    ...
    $query_str = "http://api.accuweather.com/currentconditions/v1/{$data['locationKey']}.json";
