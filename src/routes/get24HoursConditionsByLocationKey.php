...
$app->post('/api/AccuWeatherEnterprise/get24HoursConditionsByLocationKey', function ($request, $response) {
    ...
    $query_str = "http://api.accuweather.com/currentconditions/v1/{$data['locationKey']}/historical/24.json";
