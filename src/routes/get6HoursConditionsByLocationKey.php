...
$app->post('/api/AccuWeatherEnterprise/get6HoursConditionsByLocationKey', function ($request, $response) {
    ...
    $query_str = "http://api.accuweather.com/currentconditions/v1/{$data['locationKey']}/historical.json";
