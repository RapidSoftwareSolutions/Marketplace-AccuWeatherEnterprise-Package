...
$app->post('/api/AccuWeatherEnterprise/getWeatherAlarmByLocationKey', function ($request, $response) {
    ...
    $query_str = "http://api.accuweather.com/alarms/v1/{$data['days']}/{$data['locationKey']}.json";
