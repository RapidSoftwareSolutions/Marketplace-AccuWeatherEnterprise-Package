...
$app->post('/api/AccuWeatherEnterprise/getMonthClimoRecordsByLocationKey', function ($request, $response) {
    ...
    $query_str = "http://api.accuweather.com/climo/v1/records/{$data['date']}/{$data['locationKey']}.json";
