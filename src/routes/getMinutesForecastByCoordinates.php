...
$app->post('/api/AccuWeatherEnterprise/getMinutesForecastByCoordinates', function ($request, $response) {
    ...
    $query_str = "http://api.accuweather.com/forecasts/v1/minute/{$dara['minutes']}.json";
