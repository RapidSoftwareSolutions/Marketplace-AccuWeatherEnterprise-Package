...
$app->post('/api/AccuWeatherEnterprise/getMonthClimoSummaryByLocationKey', function ($request, $response) {
    ...
    $query_str = "http://api.accuweather.com/climo/v1/summary/{$data['date']}/{$data['locationKey']}.json";
